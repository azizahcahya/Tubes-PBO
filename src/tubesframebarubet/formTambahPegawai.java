...
//            String id = cust.getID_Customer();
            ...
            if (butAdmin.isSelected()){
                 sql = "INSERT INTO admin VALUES('"+txtID.getText()+"','"
                    +txtNama.getText()+"','"+txtSalary.getText()+"')";
            }else{
                 sql = "INSERT INTO pekerjalapangan VALUES('"+txtID.getText()+"','"
                    +txtNama.getText()+"','"+txtSalary.getText()+"','"+"Tidak ada"+"')";
            }
